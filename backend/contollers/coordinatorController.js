...
const reject = async (req, res) => {
  try {
    ...
    const message = 'Dear participant, your registration has been rejected by the coordinator';
    send_mail(participantMail, message);
...
const acceptall = async (req, res) => {
  try {
    ...
    users.forEach(user => {
      send_mail(user.mail, 'Dear participant, your registration has been approved by the coordinator');
    });
